...
export const floekieExperiments = [
  ...
  // ──────────────────────────────────────────────────────────
  {
    ...
    status: "draft",
    timeline: "4 weken (start na 2 weken L1 data)",
    cost: "€150/maand",
    expectedEffect:
  ...
  // ──────────────────────────────────────────────────────────
  {
    ...
    aarrStage: "revenue",
    status: "draft",
    timeline: "Continu (A/B tests per 2 weken)",
